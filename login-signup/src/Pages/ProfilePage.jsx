...
const ProfilePage = () => {
  ...
  let eachSignup_data=signup_data[0]
        ...
        <Box w={"65%"}>
          ...
          <Box>
           <Text textAlign={"left"} fontWeight="medium" fontSize={20}>
            ...
            <Text textAlign={"left"}>{eachSignup_data.skills}</Text>
           </Box>
 ...
 <Text textAlign={"left"} fontSize="20" fontWeight={"medium"}>Personal Details & Job Preferences</Text>
            <Flex mt={5} gap={100} >
              ...
              <Box >
                <Flex gap={70}  mt={5} >
                  <Text>Name :</Text>
                  <Text> {eachSignup_data.name}</Text>
                </Flex>
                <Flex  gap={8} mt={5} >
                  <Text>Home Town :</Text>
                  <Text> {eachSignup_data.location}</Text>
                </Flex>
                <Flex  gap={69} mt={5} >
                  <Text>Email :</Text>
                  <Text> {eachSignup_data.email}</Text>
                </Flex>
                <Flex  gap={62} mt={5} >
                  <Text>Mobile :</Text>
                  <Text> {eachSignup_data.mobile}</Text>
                </Flex>
              </Box>
              <Box>
              <Flex  gap={5}  mt={5}>
                  <Text>Experience in years :</Text>
                  <Text> {`${eachSignup_data.experience} years`}</Text>
                </Flex>
                <Flex  gap={83}  mt={5}>
                  <Text>Industry :</Text>
                  <Text> {eachSignup_data.industry}</Text>
                </Flex>
                <Flex  gap={70}  mt={5}>
                  <Text>Department :</Text>
                  <Text> {eachSignup_data.department}</Text>
                </Flex>
