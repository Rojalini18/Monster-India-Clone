...
export default function Carousal1() {
  ...
  return (
    <div style={{height:"170px",width:"1200px",marginLeft:"140px",backgroundColor:"white"}
    }>
    <h1 style={{fontSize:"22px",fontWeight:"bold",letterSpacing:"2px"}}>Employers of Choice</h1>
    <Box
      position={'relative'}
      height={'auto'}
      width={'100%'}
