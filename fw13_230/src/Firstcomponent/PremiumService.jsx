import { Box, Button, Divider, Heading, Image, Input, NumberInput, Radio, Stack, Text } from '@chakra-ui/react'
     ...
     <Box display={'flex'} justifyContent={'space-between'} w={'100%'} height={'400px'}>
      ...
      <div  className={Styles.leftdiv} >
        <Box mt={'60px'} width={'400px'}>
          ...
          <Box width={'100%'} height={'400px'} mt={'10px'}  boxShadow={'rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset'} p='6' rounded='md' bg='white'>
            ...
            <Button w={'95%'} mt={'-20px'} borderRadius={'5px'} color={'white'} bg={'#4b28a4'}>Buy now</Button>
          </Box>
