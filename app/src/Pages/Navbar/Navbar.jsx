  ...
  return (
    <div className='navbar-main'>
        <div className='navbar-side1'>
            <div><img style={{height:"80px",width:"140px",margin:"-4px 0 0 100px"}} src="https://media.monsterindia.com/trex/seo-search/public/default/images/monster-logo.svg" alt="" /></div>
            <div style={{margin:"26px 0 0 0px",fontFamily:"poppins",fontSize:"14px",fontWeight:"bold"}}>JOB SEARCH</div>
